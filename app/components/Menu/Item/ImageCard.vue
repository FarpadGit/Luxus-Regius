<template>
  ...
  <div
    ref="item-container" 
    :class="`item-container relative grid grid-cols-1 grid-rows-[275px_auto_auto_auto] justify-items-center p-5 bg-[var(--color-menu-card)] rounded-2xl w-full`"
  ...
  >
    <MenuImage :menu-item="menuItem" :size="200" @on-blur="handleBlur" />
    <MenuEditable
