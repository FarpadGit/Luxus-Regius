...
import MenuSectionColumn from "@app/components/Menu/Section/Column.vue";
...
describe("MenuSectionColumn", async () => {
  ...
  async function mountComponent(props: {
    ...
    component = await mountSuspended(MenuSectionColumn, {
      props,
    });
  }
  ...
  it("should display a MenuHeading component with nested MenuSectionColumn components", async () => {
    ...
    const subsections = heading.findAllComponents({
      name: "MenuSectionColumn",
    });
    const menuItems = heading.findAllComponents({ name: "MenuItemSimple" });
    ...
    childHeadings.forEach((h) =>
      menuItemsOfChildren.push(
        ...h.findAllComponents({ name: "MenuItemSimple" })
      )
    );
  ...
  it("should display a MenuHeading component with nested MenuItemSimple components", async () => {
