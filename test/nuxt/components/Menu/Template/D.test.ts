...
import TemplateD from "@app/components/Menu/Template/D.vue";
import { mockNuxtImport } from "@nuxt/test-utils/runtime";
import { mockCategory } from "@test/mocks";

describe("Template D", async () => {
  ...
  function mountComponent() {
    component = shallowMount(TemplateD);
  }
  ...
  it("should display root section components, a hidden guard dropzone component and a menu legend component", () => {
    ...
    expect(
      container.findAllComponents({ name: "MenuSectionImageColumn" }).length
